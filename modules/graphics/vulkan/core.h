...
public:
    ...
    GraphicsPipelineGroup createGraphicsPipeline(ShaderBase* shader, Window* window, RenderMode renderMode, CullMode cullMode, VkVertexInputBindingDescription bindingDescription, std::vector<VkVertexInputAttributeDescription> attributeDescriptions, VkDescriptorSetLayout* descriptorLayout);
