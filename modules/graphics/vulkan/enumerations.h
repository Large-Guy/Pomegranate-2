...
enum TopologyMode {
    TOPOLOGY_TRIANGLE_INDEXED = VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST,
    TOPOLOGY_TRIANGLE_STRIP = VK_PRIMITIVE_TOPOLOGY_TRIANGLE_STRIP,
    TOPOLOGY_TRIANGLE_FAN = VK_PRIMITIVE_TOPOLOGY_TRIANGLE_FAN,
    TOPOLOGY_LINE_INDEXED = VK_PRIMITIVE_TOPOLOGY_LINE_LIST,
    TOPOLOGY_LINE_STRIP = VK_PRIMITIVE_TOPOLOGY_LINE_STRIP,
    TOPOLOGY_POINT = VK_PRIMITIVE_TOPOLOGY_POINT_LIST
};
...
struct RenderInfo {
    ...
    TopologyMode topologyMode = TOPOLOGY_TRIANGLE_INDEXED;
};
